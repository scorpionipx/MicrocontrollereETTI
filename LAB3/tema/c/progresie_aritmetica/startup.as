	...
	; Compiler options:
	;
	; -oprogresie_aritmetica.cof -mprogresie_aritmetica.map \
	; --summary=default --output=default progresie_aritmetica.p1 \
	; --chip=16F84 -P --runtime=default --opt=default -D__DEBUG=1 -g \
